...
class GPTConfig:
    ...
    vocab_size: int = 401 # number of tokens: 50,000 BPE merges + 256 bytes tokens + 1 <|endoftext|> token
...
train_loader = DataLoaderLite(32, 256)
...
torch.save(model.state_dict(), '/Users/gsoni/Documents/Work/personal/gpt2-mlx/ckpts/mode256.pth')